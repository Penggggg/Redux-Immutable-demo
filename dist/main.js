...
/***/ function(module, exports, __webpack_require__) {
	...
	function tabsState() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? newState : arguments[0];
		var action = arguments[1];
	...
	var tabState = (0, _redux.combineReducers)({
		tabsState: tabsState
	});
...
/***/ function(module, exports) {
	...
	var CLICK_TAB = exports.CLICK_TAB = 'CLICK_TAB';

	//构造action字面量
	function clickTab(tabIndex) {
		return { type: CLICK_TAB, tabIndex: tabIndex };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabHeader = __webpack_require__(187);

	var _tabHeader2 = _interopRequireDefault(_tabHeader);

	var _tabContent = __webpack_require__(188);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_tabHeader2.default, { onClickTab: function onClickTab(index) {
	            return dispatch((0, _actions.clickTab)(index));
	          }, tabIndex: tabIndex }),
	        _react2.default.createElement(_tabContent2.default, { tabIndex: tabIndex })
	      );
	    }
	  }]);
	...
	exports.default = (0, _reactRedux.connect)(stateCallBack)(App);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabHeader = function (_Component) {
		...
		function TabHeader() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(TabHeader).apply(this, arguments));
		}

		_createClass(TabHeader, [{
			key: 'shouldComponentUpdate',
			value: function shouldComponentUpdate(nextProps) {
				return !_immutable2.default.is(_immutable2.default.fromJS(nextProps), _immutable2.default.fromJS(this.props));
			}
		}, {
			key: 'render',
			value: function render() {
				...
				var active = this.props.tabIndex;
				return _react2.default.createElement(
					'div',
					null,
			...
			key: 'clickTabs',
			value: function clickTabs(index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabContent = function (_Component) {
		...
		_createClass(TabContent, [{
			key: 'render',
			value: function render() {
				var tabIndex = this.props.tabIndex.get('indexTab');
				return _react2.default.createElement(
					'div',
			...
			key: 'renderFilter',
			value: function renderFilter(index) {
				if (index == 1) {
					return _react2.default.createElement(
						'div',
						{ className: 'tab-panel' },
